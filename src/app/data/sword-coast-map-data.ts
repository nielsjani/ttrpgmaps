...
export class SwordCoastMapData implements MapData {
  ...
  getMarkerData(): MarkerData[] {
    return [
      new MarkerData(1, 'windmill.png', -67.94, 16.50, "Umbrage Hill"),
      new MarkerData(2, 'excavation.png', -72.59, 5.53, "Dwarven Excavation"),
      new MarkerData(3, 'mushroom.png', -69.74, 28.14, "Gnomengarde"),
      new MarkerData(4, 'woodcutter.png', -14.86, 2.94, "Logger's Camp"),
      new MarkerData(5, 'falcon.png', -18.91, 25.70, "Falcon?"),
      new MarkerData(6, 'cow-skeleton.png', -31.12, 61.21, "Butterskull Ranch"),
      new MarkerData(7, 'village.png', -32.66, 52.86, "Conyberry"),
      new MarkerData(8, 'village.png', -65.39, 11.32, "Phandalin"),
    ];
  }
